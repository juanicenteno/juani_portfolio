export const t = {
  ...
  my_missionSubtitleColor4: "Follow my progress ",

  i_am: "I'm a",
  about_meDescColor: "full stack web developer",
  about_meDesc: "focused on the modern ecosystem:",
  about_meDescColor2: "Next.js, Astro and React.",
  about_meDesc2: "I started coding in 2022 and since then I've worked on real projects for clients in the hospitality and tourism industry in Argentina.",

  about_meDesc3: "Before switching to development, I worked in digital communications — which gives me a broader perspective on how technical decisions affect the end user.",
  about_meDescColor4: "",
  about_meDesc4: "",

  about_meDesc5: "I'm currently studying the",
  about_meDescColor5: "University Technician in Programming",
  about_meDesc6: "at UTN.",
  about_meDescColor6: "",
  about_meDesc7: "I wrote my first line of code around",
  ...
  my_studies_subtitle: "My academic background and the projects I've built along the way.",
  my_studies_subtitle2: "",
  download_cv: "Download CV",

  curse_1: "Full Stack Web Development",
  curse_1_desc: "Intensive 6-month course focused on full stack methodologies and SEO fundamentals.",

  curse_2: "UX-UI Design",
  curse_2_desc: "Modern, intuitive interface design focused on user experience.",

  university: "University Technician in Programming",
  university_desc: "Data structures, algorithms and software architecture. In progress since March 2026.",
